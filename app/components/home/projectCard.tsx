    ...
    return (
        <li className="flex flex-col lg:flex-row">
                    ...
                    <Image
                        src={
                            props.thumbnailImageUrl
                                ? props.thumbnailImageUrl
                                : '/images/project-thumbnail-placeholder.png'
                        }
                        alt={props.title}
                        width={400}
                        height={300}
            ...
            <div className="w-full lg:w-2/3">
                <Link
                    href={`/projects/${props.slug}`}
                    className="inline-block text-white text-xl mb-2 lg:mb-2 font-medium hover:text-primary-400 transition-colors ease-in-out"
                >
                    <h3>{props.title}</h3>
                </Link>
